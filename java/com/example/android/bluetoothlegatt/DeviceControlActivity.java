                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp | BluetoothGattCharacteristic.PROPERTY_INDICATE) > 0) {
                            ...
                            if (mNotifyCharacteristic != null) {
                                mBluetoothLeService.setLocalCharacteristicNotification(mNotifyCharacteristic, false);
                                mNotifyCharacteristic = null;
                            }
                            mNotifyCharacteristic = characteristic;
                            mBluetoothLeService.setCharacteristicNotification(characteristic, true, true);
                        }
...
//                            }
//                            mNotifyCharacteristic = characteristic;
//                            mBluetoothLeService.setLocalCharacteristicNotification(characteristic, true);
//                        }
...
//        mGattServicesList.setAdapter((SimpleExpandableListAdapter) null);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mX = (TextView) findViewById(R.id.accel_X);
        mY = (TextView) findViewById(R.id.accel_Y);
        mZ = (TextView) findViewById(R.id.accel_Z);
        mUART = (TextView) findViewById(R.id.data_UART);
